...
const RegistroForm = () => {
    ...
    // <div> intento validaciones minimas
    //     conflicto con ids form-controls
    // const validarEmail = () =>{
    ...
    // const validarNombre = () =>{
    //     let infoNombre = document.getElementsByName('nombre').value;
                ...
                <div className="container-fluid">
                    ...
                    <form className="registerForm">
                        <div className="rows">
                            ...
                            <input className="form-control" id="form-control"  type="text" placeholder="Primer apellido" name="apellido1" required="true"/>
